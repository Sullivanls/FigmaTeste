    ...
    <>
      <Column className="bg-white_A700 font-firasans items-center justify-start mx-[auto] lg:pb-[25px] xl:pb-[31px] 2xl:pb-[35px] 3xl:pb-[42px] w-[100%]">
        ...
        <Column className="items-center justify-start lg:p-[22px] xl:p-[28px] 2xl:p-[31px] 3xl:p-[38px] w-[100%]">
          ...
          <Column className="bg-white_A700 justify-start lg:mb-[36px] xl:mb-[45px] 2xl:mb-[51px] 3xl:mb-[61px] lg:mt-[15px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] lg:p-[13px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[22px] rounded-radius4 shadow-bs1 w-[98%]">
            <Text className="Form1" as="h5" variant="h5">
              Rodoviário
            </Text>
            <Row className="items-center justify-between lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] w-[100%]">
              ...
              <FloatingInput
                ...
                labelClasses="bg-white_A700 left-[16px] top-[0] text-light_blue_900"
                focusedClasses="translate-y-[20px] scale-[1]"
                wrapperClasses="w-[65%] top-[0]"
                labelText="Nome Motorista"
                defaultText="Motorista"
              ></FloatingInput>
            </Row>
            <Row className="items-center justify-between 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] w-[100%]">
              <FloatingInput
                ...
                focusedClasses="translate-y-[21px] scale-[1]"
                wrapperClasses="w-[33%] top-[0]"
                labelText="CPF/CNPJ Transportador"
            ...
            <FloatingInput
              ...
              labelText="Placa Tração"
              defaultText="AAA1234"
            ></FloatingInput>
            <Text
              className="bg-white_A700 font-normal ml-[1px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] not-italic pb-[2px] lg:pr-[32px] xl:pr-[41px] 2xl:pr-[46px] 3xl:pr-[55px] lg:pt-[15px] xl:pt-[19px] 2xl:pt-[22px] 3xl:pt-[26px] text-cyan_700 w-[990px]"
              variant="body1"
            >
              Carretas
            </Text>
            <Column className="bg-white_A700 border border-gray_300 border-solid justify-start mb-[1px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[9px] rounded-radius4 w-[100%]">
              <Row className="bg-white_A700 items-center 3xl:pr-[1064px] lg:pr-[630px] xl:pr-[788px] 2xl:pr-[887px] w-[100%]">
                ...
                <Column className="items-center w-[25%]">
                  <Column className="bg-white_A700 items-center justify-start lg:p-[12px] xl:p-[15px] 2xl:p-[17px] 3xl:p-[20px] w-[100%]">
                    <Text
                      className="font-bold mb-[1px] text-cyan_700 w-[auto]"
                      variant="body1"
                    >
                      Carreta
                    </Text>
